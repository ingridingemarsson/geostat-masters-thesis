...
python -u ${HOME}/geostat-masters-thesis/src/train_boxes.py -p "$TMPDIR/dataset-boxes/" -s "${HOME}/geostat-masters-thesis/results/" -b 64 --log True -m 'boxes_one' -e 10 -lr 0.001
